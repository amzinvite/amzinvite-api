...
| `GET` | `/api/public/waves` | Vagues anonymes agrégées sur les créneaux du lundi 20 h et du vendredi 10 h (Europe/Paris) ; statut live pendant 24 h puis archive immuable ; le total d'installations exclut les identifiants techniques non réutilisés après une heure |
